...
urlpatterns = [
  ...
  path('video-questlist/<str:pk>', views.videoQuestList, name="video-questlist"),
  ...
  path('rail-vidlist/<str:pk>', views.railVideoList, name="rail-vidlist"),
  ...
  path('user-results', views.userResults, name="user-results"),
  path('user-create', views.userCreate, name="user-create"),
  path('user-update/<str:pk>', views.userUpdate, name="user-update"),
  path('user-delete/<str:pk>', views.userDelete, name="user-delete"),
]
