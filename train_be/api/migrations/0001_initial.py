    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_railway', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_vid', to='api.railway')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_quest', to='api.video')),
            ],
            options={
                'ordering': ['id'],
            },
